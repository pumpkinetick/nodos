...
BASE_POP_CAP = 50.0
RES_POP_CAP_BOOST = 100.0

BASE_HAPPINESS = 0.0
COM_HAPPY_BOOST = 0.01
IND_HAPPY_PENALTY = 0.005
...
IND_RES_PROD = 10.0
COM_RES_PROD = 0.1 # Generated per citizen
POP_CONSUMPTION_RATE = 0.1 # Consumed per citizen

# --- Action Costs ---
BUILD_DISTRICT_COST = 50.0
CHANGE_DISTRICT_COST = 20.0
DEMOLISH_REFUND = 10.0
